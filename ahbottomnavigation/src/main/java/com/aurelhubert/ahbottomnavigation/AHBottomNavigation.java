...
public class AHBottomNavigation extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                dividerColor = ta.getColor(R.styleable.AHBottomNavigationBehavior_Params_dividerColor, ContextCompat.getColor(context, R.color.colorBottomNavigationDivider));
        ...
        dividerHeight = (int) resources.getDimension(R.dimen.divider_height);
    ...
    private void createItems() {
        ...
        LayoutParams dividerLayoutParams = new LayoutParams(
